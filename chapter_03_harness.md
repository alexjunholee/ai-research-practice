...
AI와 작업하다 보면 한 번에 바뀌는 자리가 쉽게 늘어난다. 로그 분석으로 시작한 일이 코드 수정으로 번지고, 끝에는 실험 해석과 원고 문장까지 따라오기도 한다. 번진 요청 하나는 그 자리들을 같이 바꿔 놓으므로, 결과가 달라졌을 때 까닭 후보도 같이 늘어난다. 적어 둔 것을 다시 돌려 볼 때 그사이 바뀐 자리가 하나면, 결과가 달라진 까닭도 그 하나로 좁혀진다.
