...
연구실에서 필요한 것은 이 논문들의 거대한 web-scale index가 아니다. 어느 논문 PDF, 어느 code path, 어느 실험 로그, 어느 reviewer comment를 어떤 단위로 잘라 두고, 질문이 들어왔을 때 무엇을 찾아 쓸지 정하는 일이다. 답의 품질은 모델의 parameter뿐 아니라 바깥 자료를 얼마나 정확히 찾아 쓰느냐에 달려 있다.
