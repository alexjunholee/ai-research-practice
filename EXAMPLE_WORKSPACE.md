...
| [`project-memory.json`](examples/first-robotics-workspace/project-memory.json) | 현재 truth, source of truth, evidence boundary, 첫 연구 루프, 다음 행동 |
| [`first-ai-session-message.txt`](examples/first-robotics-workspace/notes/first-ai-session-message.txt) | 첫 AI 세션에 바로 붙일 수 있는 메시지 |
...
| [`first-ai-session-prompt.md`](examples/first-robotics-workspace/notes/first-ai-session-prompt.md) | 첫 AI 세션에 그대로 붙이는 읽기 순서와 evidence gate |
| [`first-day-workspace-checklist.md`](examples/first-robotics-workspace/notes/first-day-workspace-checklist.md) | 첫날 source of truth와 첫 action 경계 |
...
이 예시는 첫날 AI가 어디서 시작해야 하는지 알 수 있을 만큼만 채운 상태다.
